...
var gBaseURL = {
	...
	menu1 : gRootURL.root+'_wsg/html/rule/',
...
var include = {
	meta : function(){
		document.write('<title>프로젝트 - Standard Guide</title>');
		document.write('<meta http-equiv="X-UA-Compatible" content="IE=edge" />');
		document.write('<meta name="viewport" content="width=device-width,initial-scale=1.0,minimum-scale=1.0,maximum-scale=1.0,user-scalable=no" />');
		document.write('<meta name="keywords" content="웹스타일가이드, 퍼블리싱가이드, STANDARD-UI">');
		document.write('<meta name="description" content="웹스타일가이드, 퍼블리싱가이드, STANDARD-UI">');
	},
	head : function(){
	...
	header : function(){
		...
		document.write('				<ul>');
		document.write('					<li><a href="'+gBaseURL.menu4+'index.html" data-aside="g-snbMenu4" data-url="'+gBaseURL.menu4+'">현황판</a></li>');
		document.write('					<li><a href="'+gBaseURL.menu1+'rule_intro.html" data-aside="g-snbMenu1" data-url="'+gBaseURL.menu1+'">퍼블리싱가이드</a></li>');
		...
		document.write('					<li><a href="'+gBaseURL.menu5+'wa_index.html" data-aside="g-snbMenu5" data-url="'+gBaseURL.menu5+'">접근성가이드</a></li>');
	...
	aside : {
		...
		menu1 : function(){
			...
			document.write('							<li class="g-node2"><a href="'+baseURL+'rule_codeset.html">설계패턴</a></li>');
			document.write('						</ul>');
			document.write('					</li>');
			document.write('				</ul>');
			document.write('				<!-- //Convention -->');
		...
		menu2 : function(){
			...
			document.write('						<ul class="g-depth2">');
			document.write('							<li class="g-node2"><a href="'+baseURL+'plan_codeset.html">코드설계</a></li>');
			...
			document.write('							<li class="g-node2"><a href="'+baseURL+'plan_general.html">주의사항</a></li>');
		...
		menu3 : function(){
			...
			document.write('							<li class="g-node2"><a href="'+baseURL+'elements_define.html">Detail</a></li>');
			...
			document.write('							<li class="g-node2"><a href="'+baseURL+'modules_drop.html">Drop</a></li>');
			document.write('							<li class="g-node2"><a href="'+baseURL+'modules_popup.html">Popover</a></li>');
			...
			document.write('							<li class="g-node2"><a href="'+baseURL+'modules_spyscroll.html">SpyScroll</a></li>');
			document.write('							<li class="g-node2"><a href="'+baseURL+'modules_floaing.html">Floating</a></li>');
			document.write('							<li class="g-node2"><a href="'+baseURL+'modules_customscroll.html">CustomScrollbar</a></li>');
			document.write('						</ul>');
			document.write('					</li>');
			document.write('					<li class="g-node1">');
		...
		menu5 : function(){
			...
			document.write('							<li class="g-node2"><a href="'+baseURL+'wa_wai.html">웹접근성 WAI-ARIA</a></li>');
