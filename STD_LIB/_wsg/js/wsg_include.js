...
var include = {
	...
	aside : {
		...
		menu1 : function(){
			...
			document.write('							<li class="g-node2"><a href="'+baseURL+'elements_formControls.html">Form Controls</a></li>');
		...
		menu2 : function(){
			...
			document.write('							<li class="g-node2"><a href="'+baseURL+'modules_sticky.html">Sticky Scroll</a></li>');
